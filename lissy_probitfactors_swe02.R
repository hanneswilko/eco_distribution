...
fused_swe02$netwealth_quantile <- factor(fused_swe02$netwealth_quantile, levels = c("1", "2", "3", "4", "5"), 
                                         labels = c("first", "second", "third", "fourth", "fifth"), ordered = TRUE)
fused_swe02$wealth_quantile <- factor(fused_swe02$wealth_quantile, levels = c("1","2","3","4","5"),
                                      labels = c("first", "second", "third", "fourth", "fifth"), ordered = TRUE)
fused_swe02$haf_quantile <- factor(fused_swe02$haf_quantile, levels = c("1","2","3","4","5"),
                                   labels = c("first", "second", "third", "fourth", "fifth"), ordered = TRUE)
fused_swe02$han_quantile <- factor(fused_swe02$han_quantile, levels = c("1","2","3","4","5"),
                                   labels = c("first", "second", "third", "fourth", "fifth"), ordered = TRUE)
